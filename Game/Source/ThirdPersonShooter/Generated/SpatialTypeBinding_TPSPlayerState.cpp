...
#include "TPSPlayerStateHandoverDataAddComponentOp.h"

const FRepHandlePropertyMap& USpatialTypeBinding_TPSPlayerState::GetRepHandlePropertyMap() const
{
	return RepHandleToPropertyMap;
}

const FHandoverHandlePropertyMap& USpatialTypeBinding_TPSPlayerState::GetHandoverHandlePropertyMap() const
{
	return HandoverHandleToPropertyMap;
}

UClass* USpatialTypeBinding_TPSPlayerState::GetBoundClass() const
{
	return ATPSPlayerState::StaticClass();
}

void USpatialTypeBinding_TPSPlayerState::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	Super::Init(InInterop, InPackageMap);


	UClass* Class = FindObject<UClass>(ANY_PACKAGE, TEXT("TPSPlayerState"));
...
void USpatialTypeBinding_TPSPlayerState::BindToView(bool bIsClient)
{
	...
	{
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData::ComponentId))
			{
				return;
			}
		...
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData::ComponentId))
			{
				return;
			}
			USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
	...
	ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateNetMulticastRPCs>([this](
		const worker::ComponentUpdateOp<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateNetMulticastRPCs>& Op)
	{
		// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
		if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::tpsplayerstate::TPSPlayerStateNetMulticastRPCs::ComponentId))
		{
			return;
		}
...
void USpatialTypeBinding_TPSPlayerState::UnbindFromView()
{
	ViewCallbacks.Reset();
}

worker::Entity USpatialTypeBinding_TPSPlayerState::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData::Data SingleClientTPSPlayerStateData;
	improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData::Update SingleClientTPSPlayerStateUpdate;
	bool bSingleClientTPSPlayerStateUpdateChanged = false;
	improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData::Data MultiClientTPSPlayerStateData;
	improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData::Update MultiClientTPSPlayerStateUpdate;
	bool bMultiClientTPSPlayerStateUpdateChanged = false;
	improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData::Data TPSPlayerStateHandoverData;
	improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData::Update TPSPlayerStateHandoverDataUpdate;
	bool bTPSPlayerStateHandoverDataUpdateChanged = false;

	BuildSpatialComponentUpdate(InitialChanges, Channel, SingleClientTPSPlayerStateUpdate, bSingleClientTPSPlayerStateUpdateChanged, MultiClientTPSPlayerStateUpdate, bMultiClientTPSPlayerStateUpdateChanged, TPSPlayerStateHandoverDataUpdate, bTPSPlayerStateHandoverDataUpdateChanged);
	SingleClientTPSPlayerStateUpdate.ApplyTo(SingleClientTPSPlayerStateData);
	MultiClientTPSPlayerStateUpdate.ApplyTo(MultiClientTPSPlayerStateData);
	TPSPlayerStateHandoverDataUpdate.ApplyTo(TPSPlayerStateHandoverData);
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData>(SingleClientTPSPlayerStateData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData>(MultiClientTPSPlayerStateData, WorkersOnly)
...
void USpatialTypeBinding_TPSPlayerState::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData>(EntityId.ToSpatialEntityId(), SingleClientUpdate);
	}
	if (bMultiClientUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData>(EntityId.ToSpatialEntityId(), MultiClientUpdate);
	}
	if (bHandoverDataUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData>(EntityId.ToSpatialEntityId(), HandoverDataUpdate);
	}
}

void USpatialTypeBinding_TPSPlayerState::SendRPCCommand(UObject* TargetObject, const UFunction* const Function, void* Parameters)
{
	TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
...
void USpatialTypeBinding_TPSPlayerState::ReceiveAddComponent(USpatialActorChannel* Channel, UAddComponentOpWrapperBase* AddComponentOp) const
{
	auto* SingleClientAddOp = Cast<UTPSPlayerStateSingleClientRepDataAddComponentOp>(AddComponentOp);
	if (SingleClientAddOp)
	{
		auto Update = improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData::Update::FromInitialData(*SingleClientAddOp->Data.data());
		ReceiveUpdate_SingleClient(Channel, Update);
		return;
	}
	auto* MultiClientAddOp = Cast<UTPSPlayerStateMultiClientRepDataAddComponentOp>(AddComponentOp);
	if (MultiClientAddOp)
	{
		auto Update = improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData::Update::FromInitialData(*MultiClientAddOp->Data.data());
		ReceiveUpdate_MultiClient(Channel, Update);
		return;
	}
	auto* HandoverDataAddOp = Cast<UTPSPlayerStateHandoverDataAddComponentOp>(AddComponentOp);
	if (HandoverDataAddOp)
	{
		auto Update = improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData::Update::FromInitialData(*HandoverDataAddOp->Data.data());
		ReceiveUpdate_Handover(Channel, Update);
		return;
	}
}

worker::Map<worker::ComponentId, worker::InterestOverride> USpatialTypeBinding_TPSPlayerState::GetInterestOverrideMap(bool bIsClient, bool bAutonomousProxy) const
{
	...
	if (bIsClient)
	{
		if (!bAutonomousProxy)
		{
			Interest.emplace(improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData::ComponentId, worker::InterestOverride{false});
		}
		Interest.emplace(improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData::ComponentId, worker::InterestOverride{false});
	}
	return Interest;
}

void USpatialTypeBinding_TPSPlayerState::BuildSpatialComponentUpdate(
...
void USpatialTypeBinding_TPSPlayerState::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TPSPlayerState::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
...
void USpatialTypeBinding_TPSPlayerState::ServerSendUpdate_Handover(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TPSPlayerState::ReceiveUpdate_SingleClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::tpsplayerstate::TPSPlayerStateSingleClientRepData::Update& Update) const
{
...
void USpatialTypeBinding_TPSPlayerState::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::tpsplayerstate::TPSPlayerStateMultiClientRepData::Update& Update) const
{
	AActor* TargetObject = ActorChannel->Actor;
	ActorChannel->PreReceiveSpatialUpdate(TargetObject);
	...
	const bool bAutonomousProxy = ActorChannel->IsClientAutonomousProxy(improbable::unreal::generated::tpsplayerstate::TPSPlayerStateClientRPCs::ComponentId);
	...
	if (!Update.field_selectedteam0().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			Value = ETPSTeam((*Update.field_selectedteam0().data()));
...
void USpatialTypeBinding_TPSPlayerState::ReceiveUpdate_Handover(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::tpsplayerstate::TPSPlayerStateHandoverData::Update& Update) const
{
}

void USpatialTypeBinding_TPSPlayerState::ReceiveUpdate_NetMulticastRPCs(worker::EntityId EntityId, const improbable::unreal::generated::tpsplayerstate::TPSPlayerStateNetMulticastRPCs::Update& Update)
{
}
