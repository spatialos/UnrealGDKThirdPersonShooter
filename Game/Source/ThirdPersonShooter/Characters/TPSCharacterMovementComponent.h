...
public:
	friend class FSavedMove_TPSMovement;

	UTPSCharacterMovementComponent(const FObjectInitializer& ObjectInitializer);
...
class FSavedMove_TPSMovement : public FSavedMove_Character
{
public:
...
class FNetworkPredictionData_Client_TPSMovement : public FNetworkPredictionData_Client_Character
{
public:
	FNetworkPredictionData_Client_TPSMovement(const UCharacterMovementComponent& ClientMovement);
